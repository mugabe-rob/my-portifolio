...
![Portfolio Demo](https://i.postimg.cc/zGsVjtyP/Screenshot-2025-06-26-154129.png)
...
[**Live Demo**](https://mugabe-robert.vercel.app/)
---
### 🎯 Project Structure
```bash
portfolio/
...
2. After forking, open your terminal and run the following commands to clone the repo:
  ...
  ```bash
  git clone https://github.com/mugabe-rob/my-portfolio
  ```
...
<div align="center"> Made with ❤️ by Robert MUGABE </div>
